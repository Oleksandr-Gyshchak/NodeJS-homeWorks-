...
const getPostlist = async function (req, res, next) {
    try {
        ...
        const perPage = 3;
        const page = Math.max(0, req.query.page || 0) - 1;

        const paginationConfig = {
            itemPerPage: perPage,
            skipItem: perPage * page
        };
        ...
        const postList = await PostModel.paginate(query, options);

        //const postList2 = await PostModel.getPostsPagination(postList);
